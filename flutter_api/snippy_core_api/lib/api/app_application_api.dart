...
class AppApplicationApi {
  ...
  /// Performs an HTTP 'GET /collections' operation and returns the [Response].
  Future<Response> collectionsWithHttpInfo() async {
  ...
  Future<String> collections() async {
    final response = await collectionsWithHttpInfo();
  ...
  /// Performs an HTTP 'GET /logs/{id}' operation and returns the [Response].
  /// Parameters:
  ///
  /// * [String] id (required):
  Future<Response> logsWithHttpInfo(String id) async {
    // Verify required params are set.
    if (id == null) {
     throw ApiException(HttpStatus.badRequest, 'Missing required param: id');
    }

    final path = r'/logs/{id}'
  ...
  Future<String> logs(String id) async {
    final response = await logsWithHttpInfo(id);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
