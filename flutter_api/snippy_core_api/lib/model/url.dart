...
class Url {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is Url &&
     other.id == id &&
     other.url == url &&
  ...
  @override
  String toString() => 'Url[id=$id, url=$url, ownerEmail=$ownerEmail]';
  ...
  static Url fromJson(Map<String, dynamic> json) => json == null
    ...
    : Url(
        id: json[r'id'],
        url: json[r'url'],
        ownerEmail: json[r'ownerEmail'],
    );

  static List<Url> listFromJson(List<dynamic> json, {bool emptyIsNull, bool growable,}) =>
    json == null || json.isEmpty
      ? true == emptyIsNull ? null : <Url>[]
  ...
  static Map<String, List<Url>> mapListFromJson(Map<String, dynamic> json, {bool emptyIsNull, bool growable,}) {
    final map = <String, List<Url>>{};
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) {
        map[key] = Url.listFromJson(v, emptyIsNull: emptyIsNull, growable: growable);
      });
    }
    return map;
  }
